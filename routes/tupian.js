...
router.post('/img', function(req, res) {
	...
	form.parse(req, function(error, fields, files) {
		...
		con.query(`INSERT INTO tupain (img) VALUES ('upload/${fName}')`, function(err, rows) {
...
//	res.header('Access-Control-Allow-Origin', "*")
//	var id=req.body.id;
//	con.query(`DELETE FROM tupian WHERE id='${id}'`, function(err, rows, fields) {
//		res.send('删除成功')
//	})
//})
...
// 	con.query(`SELECT * FROM tupian WHERE id LIKE '%${sum}%' OR img LIKE '%${sum}%'`,function(err,rows,fields){
// 		res.send(rows)
// 	})
//});
